...
skills: resume.skills?.length? resume.skills : data.skills,
  ...
  <h1 className="text-sm text-white text-center mt-1">{finalData.name || data.name}</h1> 
   <p className=" text-[0.4rem] text-center text-white mb-1">{finalData.experience?.[0]?.position || data.experience?.[0]?.position}</p> 
  </div>

  {/* SUMMERY  */}
  <div className="border-b-1 border-pink-900 mt-0.5 mb-2">
  <h3 className="text-[0.4rem] font-bold text-start pt-1 text-pink-900 mb-1">Summary</h3> 
  <p className="text-[0.3rem] mb-1 ">{finalData.summary || data.summary}</p>

  </div>
{/* CONTACT */}
<div className="border-b-1 border-pink-900 mb-2 ">
  <h3 className="text-[0.4rem] font-bold text-start text-pink-900 mb-1">Contact</h3> 

  <div className="flex gap-3">
    <p className="text-[0.3rem] mb-1">   <span className="font-bold text-pink-900" >Mobile -</span> {finalData.phone || data.phone}</p>
  <p className="text-[0.3rem]  ">  <span className="font-bold text-pink-900" >Email - </span>{finalData.email || data.email}</p>
...
{/* Skills */}
  ...
  <div className="border-b-1 border-pink-900 mt-0.5 mb-2">
  <h3 className="text-[0.4rem] font-bold text-start mb-1 text-pink-900">Skills</h3> 
...
{/* Education */}
  ...
  <div className="border-b-1 border-pink-900 mt-0.5 mb-2">
  <h3 className="text-[0.4rem] font-bold text-start text-pink-900 mb-1">Education</h3> 
...
{/* Experience */}
  ...
  <div className="border-b-1 border-pink-900 mt-0.5 mb-2  ">
  <h3 className="text-[0.4rem] font-bold text-start text-pink-900 mb-1 ">Experience</h3> 
